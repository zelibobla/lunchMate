...
module.exports = {
  ...
  noTemplates: `There is no any invitation template.\n` +
    `To create template type /create_template <eatPlace>,<meetPlace>,<delay>,<timeout>\n` +
  ...
  templateBrief: (template) => `${template.timeout} mins to think, ${template.delay} mins to get ` +
